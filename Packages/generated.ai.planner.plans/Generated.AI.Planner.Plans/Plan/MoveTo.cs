...
namespace Generated.AI.Planner.Plans.Plan
{
    ...
    struct MoveTo : IJobParallelForDefer
    {
        ...
        [NativeDisableContainerSafetyRestriction] NativeList<MoveToFixupReference> TransitionInfo;
        ...
        void InitializeLocalContainers()
        {
            ...
            TargetFilter = new NativeArray<ComponentType>(1, Allocator.Temp){[0] = ComponentType.ReadWrite<Location>(),  };
            TargetObjectIndices = new NativeList<int>(2, Allocator.Temp);

            ArgumentPermutations = new NativeList<ActionKey>(4, Allocator.Temp);
            TransitionInfo = new NativeList<MoveToFixupReference>(ArgumentPermutations.Length, Allocator.Temp);
        }
        ...
        StateTransitionInfoPair<StateEntityKey, ActionKey, StateTransitionInfo> ApplyEffects(ActionKey action, StateEntityKey originalStateEntityKey)
        {
            ...
            {
                    var @Location = newLocationBuffer[originalPlayerObject.LocationIndex];
                    @Location.Position = newLocationBuffer[originalTargetObject.LocationIndex].Position;
                    newLocationBuffer[originalPlayerObject.LocationIndex] = @Location;
            }
        ...
        public void Execute(int jobIndex)
        {
            ...
            {
                TransitionInfo.Add(new MoveToFixupReference { TransitionInfo = ApplyEffects(ArgumentPermutations[i], stateEntityKey) });
            }
